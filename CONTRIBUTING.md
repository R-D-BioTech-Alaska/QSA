...
The current QSA source is licensed under PolyForm Strict 1.0.0, which does not grant permission to create or distribute modifications. Do not publish a fork, patch, derivative work, or pull request containing modified QSA code without written permission from the applicable copyright holder.
...
Security reports must follow SECURITY.md and should not be posted publicly with exploit details.
